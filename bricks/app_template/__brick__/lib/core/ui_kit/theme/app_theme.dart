...
class AppTheme {
  ...
  static ThemeData light() {
    ...
    return ThemeData(
      ...
      elevatedButtonTheme:
          ElevatedButtonThemeData(style: AppButtonTheme.primaryButton),
      outlinedButtonTheme:
          OutlinedButtonThemeData(style: AppButtonTheme.secondaryButton),
      ...
      dividerTheme:
          DividerThemeData(color: AppSemanticColors.border.withAlpha(120)),
      extensions: [
        AppCustomColors(
          ...
          primaryGradient: LinearGradient(
            colors: [AppSemanticColors.primary, AppSemanticColors.secondary],
